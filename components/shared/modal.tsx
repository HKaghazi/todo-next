    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className={cn(
            "fixed inset-0 z-40 m-auto !h-min hidden max-h-fit w-full max-w-md animate-scale-in overflow-hidden rounded-2xl border border-gray-200 bg-white p-0 shadow-xl md:block",
            className,
          )}
        >
          {!hideHeader && (
            <header className="flex justify-between items-center py-2 px-4 border-b">
              ...
              <button
                type="button"
                className="p-1 border-none hover:bg-gray-200 duration-300 rounded-lg"
                onClick={() => closeModal()}
              >
                X
              </button>
